...
function gen_menu() {
	...
	if ($sess_level == "guru") {
	  $menu = array(
	            ...
	            array("icon"=>"file", "url"=>"m_ujian", "text"=>"Buat Ujian"),
	  ...
	  $menu = array(
	            array("icon"=>"dashboard", "url"=>"", "text"=>"Dashboard"),
	            array("icon"=>"list-alt", "url"=>"m_guru", "text"=>"Data Departemen"),
				array("icon"=>"list-alt", "url"=>"m_siswa", "text"=>"Data Peserta"),
	            array("icon"=>"list-alt", "url"=>"m_mapel", "text"=>"Data Jenis Soal"),
	            array("icon"=>"list-alt", "url"=>"m_soal", "text"=>"Total Soal"),
	            array("icon"=>"file", "url"=>"h_ujian", "text"=>"Hasil Ujian"),
	          );
	} else {
	  $menu = array(
